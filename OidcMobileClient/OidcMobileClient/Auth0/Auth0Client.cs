...
public class Auth0Client
{
    ...
    {
        //return await oidcClient.LoginAsync();   // Benyttes hvis der ikke kaldes et WebApi
    ...
    public async Task<BrowserResult> LogoutAsync()
    {
        ...
        //var endSessionUrl = new RequestUrl($"{oidcClient.Options.Authority}/v2/logout")           // Auth0
        var endSessionUrl = new RequestUrl($"{oidcClient.Options.Authority}/connect/endsession")    // Duende
